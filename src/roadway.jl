...
const ROADWAY_80 = open(io->read(io, Roadway), joinpath(@__DIR__, "../data/ngsim_80.txt"), "r")
const ROADWAY_101 = open(io->read(io, Roadway), joinpath(@__DIR__, "../data/ngsim_101.txt"), "r")
